...
const freshRequire_1 = __nccwpck_require__(69);
const backgroundColourPlugin_1 = __nccwpck_require__(412);
class ChartJSNodeCanvas {
    ...
    initialize(options) {
        var _a, _b, _c, _d;
        const chartJs = __nccwpck_require__(745);
        ...
        delete require.cache[__nccwpck_require__.ab + "chart.js"];
        return chartJs;
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const chartjs_node_canvas_1 = __nccwpck_require__(589);
...
function run(data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield fs_1.promises.writeFile(output_file, buffer, 'base64');
        }
        catch (e) {
            console.error(e);
            process.exit(1);
