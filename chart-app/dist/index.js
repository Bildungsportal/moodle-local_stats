...
exports.VERSION = {
    ...
    typescript: '5.9.3',
    ncc: '0.38.4',
    buildDate: '2026-03-01T14:37:23.290Z',
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const chartjs_node_canvas_1 = __nccwpck_require__(347);
const fs_1 = __nccwpck_require__(896);
const version_1 = __nccwpck_require__(377);
if (process.argv.includes('--version') || process.argv.includes('-v')) {
    console.log(`chart-app v${version_1.VERSION.app}`);
    console.log(`  TypeScript: ${version_1.VERSION.typescript}`);
    console.log(`  ncc: ${version_1.VERSION.ncc}`);
    console.log(`  Built: ${version_1.VERSION.buildDate}`);
    process.exit(0);
}
let inputData = '';
...
function run(data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let configuration = {
            ...
            data: {
                datasets: chart.series.map((series, series_i) => {
                    var _a, _b, _c, _d;
                    return (Object.assign({ data: series.values, backgroundColor: (_b = (_a = series.fill) !== null && _a !== void 0 ? _a : ((type == 'pie' || type == 'doughnut')
                            ? chart.config_colorset
                            : chart.config_colorset[series_i + 1])) !== null && _b !== void 0 ? _b : "#ff7f0e", borderColor: (type == 'line')
                            ? (_c = chart.config_colorset[series_i + 1]) !== null && _c !== void 0 ? _c : "#ff7f0e"
                            : undefined, 
                        // smooth interpolation
                        tension: ((_d = series.smooth) !== null && _d !== void 0 ? _d : chart.smooth) ? 0.4 : 0 }, series));
                }),
                "labels": chart.labels,
            },
            options: {
        ...
        configuration = Object.assign(Object.assign({}, chart), configuration);
        const chartCallback = (ChartJS) => {
            // ChartJS.defaults.responsive = true;
            // ChartJS.defaults.maintainAspectRatio = false;
        };
        try {
            const chartJSNodeCanvas = new chartjs_node_canvas_1.ChartJSNodeCanvas({ width, height, chartCallback });
            const buffer = yield chartJSNodeCanvas.renderToBuffer(configuration);
            yield fs_1.promises.writeFile(output_file, new Uint8Array(buffer));
        }
        catch (e) {
            console.error(e);
            process.exit(1);
...
const chartJSNodeCanvasBase_1 = __nccwpck_require__(977);
...
const freshRequire_1 = __nccwpck_require__(296);
const backgroundColourPlugin_1 = __nccwpck_require__(56);
class ChartJSNodeCanvasBase {
    ...
    initialize(options) {
        var _a, _b, _c, _d;
        const chartJs = __nccwpck_require__(569);
...
tslib_1.__exportStar(__nccwpck_require__(240), exports);
tslib_1.__exportStar(__nccwpck_require__(977), exports);
...
const chartjs = __nccwpck_require__(509);
...
var helpers_dataset = __nccwpck_require__(905);
...
var color$1 = __nccwpck_require__(421);
