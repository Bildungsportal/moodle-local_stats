...
$string['report:change_warning'] = 'The SQL query is loaded from the file {dataroot}/local_stats_reports/{id}.sql. After changing the file, if the new query is not data-compatible with the previous one, you should wipe all data once.';
...
$string['report:query_help'] = 'The SQL query is loaded from {dataroot}/local_stats_reports/{id}.sql. It must provide the following columns: periodid, subid, periodvalue and lasttimecreated.';
