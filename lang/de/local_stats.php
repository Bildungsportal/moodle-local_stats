...
$string['report:change_warning'] = 'Die SQL-Abfrage wird aus der Datei {dataroot}/local_stats_reports/{id}.sql geladen. Falls die neue Abfrage nicht zu den bisherigen Daten kompatibel ist, sollten Sie die Daten einmalig zurücksetzen.';
...
$string['report:query_help'] = 'Die SQL-Abfrage wird aus {dataroot}/local_stats_reports/{id}.sql geladen. Sie muss folgende Spalten als Rückgabewerte liefern: periodid, subid, periodvalue und lasttimecreated.';
